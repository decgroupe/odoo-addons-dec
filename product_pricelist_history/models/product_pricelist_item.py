...
class ProductPricelistItem(models.Model):
    ...
    def _compute_price(self, price, price_uom, product, quantity=1.0, partner=False):
        ...
        if history and history.get("level") > 0:
            self._compute_price_history(price, price_uom, product, quantity, partner)
    ...
    # yapf: disable
    def _compute_price_history(self, price, price_uom, product, quantity=1.0, partner=False):
