...
class sale_order_dec(report_sxw.rml_parse):
    def __init__(self, cr, uid, name, context):
        super(sale_order_dec, self).__init__(cr, uid, name, context)
    ...
    def sale_order_lines(self, sale_order):
        ...
        for entry in order_lines:
            ...
            if entry.layout_type == 'article':
                ...
                res['price_discount'] = entry.price_discount or 0.00
...
report_sxw.report_sxw('report.sale.order.base', 'sale.order', 'addons-dec/dec_sale/report/report_base.rml', parser=sale_order_dec)
report_sxw.report_sxw('report.sale.order.discount', 'sale.order', 'addons-dec/dec_sale/report/report_discount.rml', parser=sale_order_dec)
