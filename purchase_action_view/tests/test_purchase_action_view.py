...
class TestPurchaseActionView(TransactionCase):
    """ """

    @classmethod
    def setUpClass(cls):
        super().setUpClass()
        cls.model_purchase_order = cls.env["purchase.order"]
        cls.model_purchase_order_line = cls.env["purchase.order.line"]
        ctx = {
    ...
    def test_01_purchase_order_action_view(self):
        self._test_action_view_sm_records(self.model_purchase_order)

    def test_02_purchase_order_line_action_view(self):
        self._test_action_view_sm_records(self.model_purchase_order_line)
