...
class ProductTemplate(models.Model):
    ...
    def write(self, vals):
        if (
            self.env.ref("product_change_uom.group_product_uom_change")
    ...
    def change_uom(self, vals):
        ...
        product_variant_ids = updated.with_context(active_test=False).mapped(
            "product_variant_ids"
        )
    ...
    def _propagate_uom_change_to_quants(self, uom_id, product_ids):
        ...
        for quant in quant_ids:
            ...
            quant.quantity = current_uom_id._compute_quantity(quant.quantity, uom_id)
    ...
    def _propagate_uom_change_to_packagings(self, uom_id, product_ids):
        ...
        for packaging in packaging_ids:
            ...
            packaging.qty = current_uom_id._compute_quantity(packaging.qty, uom_id)
