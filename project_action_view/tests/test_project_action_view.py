...
class TestProjectActionView(TransactionCase):
    """ """

    @classmethod
    def setUpClass(cls):
        super().setUpClass()
        cls.model_project_project = cls.env["project.project"]
        cls.model_project_task = cls.env["project.task"]
        ctx = {
    ...
    def test_01_project_project_action_view(self):
        self._test_action_view_sm_records(self.model_project_project)

    def test_01_project_task_action_view(self):
        self._test_action_view_sm_records(self.model_project_task)
