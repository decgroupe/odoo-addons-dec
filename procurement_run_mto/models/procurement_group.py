...
class ProcurementGroup(models.Model):
    ...
    def _run_scheduler_tasks(self, use_new_cursor=False, company_id=False):
        ...
        self.sudo()._retry_orphan_mto_moves(company_id=company_id)
    ...
    @api.model
    def _retry_orphan_mto_moves(self, company_id=False):
    ...
    def _filter_mto_picking_moves_to_confirm(self, picking_ids):
        return picking_ids.mapped("move_ids").filtered(
            ...
            and not x.created_mrp_production_request_id
    ...
    def _action_confirm_one_move(self, move):
        move.ensure_one()
        _logger.info(
            "Execute method _action_confirm on "
            f"{move.product_id.display_name} ({move.picking_id.display_name})"
        )
        move._do_unreserve()
