odoo.define('mail_activity_team_image/static/src/components/activity/activity.js',
    function (require) {
        "use strict";
        ...
        patch(
            components.Activity,
            "mail_activity_team_image/static/src/components/activity/activity.js",
            {
                /**
                ...
                */
                assignedTeamText() {
                    return _.str.sprintf(this.env._t("for %s"), this.activity.team.displayName);
                },
            }
        );
    }
