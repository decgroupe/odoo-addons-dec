...
class BaseParser:
    ...
    def __init__(
        ...
        *,
        ...
        self._encoding = None
        self._html = html.encode(DEFAULT_ENCODING
    ...
    def encoding(self) -> _Encoding:
        ...
        if self._html:
            self._encoding = html_to_unicode(self.default_encoding,
                                             self._html)[0]
        ...
        *,
        ...
        if containing:
            ...
            for element in elements_copy:
                if any(
                    [
                        c.lower() in element.full_text.lower()
                        for c in containing
                    ]
                ):
    ...
    def xpath(
        ...
        *,
        ...
        elements = [
            ...
            ) if not isinstance(selection, etree._ElementUnicodeResult) else
            str(selection) for selection in selected
        ]
        ...
        def gen():
            for link in self.find('a'):
                ...
                try:
                    ...
                    if href and not (
                        href.startswith('#') and self.skip_anchors
...
class Element(BaseParser):
    ...
    def __repr__(self) -> str:
        attrs = [
            '{}={}'.format(attr, repr(self.attrs[attr])) for attr in self.attrs
        ]
    ...
    def __init__(
        ...
        *,
        ...
        super(HTML, self).__init__(
            ...
            element=PyQuery(html)('html') or
            PyQuery(f'<html>{html}</html>')('html'),
            html=html,
            url=url,
