...
class account_invoice_1(report_sxw.rml_parse):
    ...
    def invoice_lines(self, invoice):
        ...
        for entry in invoice_list:
            ...
            result.append(res)
        return result
report_sxw.report_sxw('report.account.invoice.layout.dec', 'account.invoice', 'addons-dec/dec_account_invoice_layout/report/report_account_invoice_layout.rml', parser=account_invoice_1, header="external")
